...
INSERT INTO Subscription (start, end, stripe_id) VALUES ('2015-03-01', null, 'stripe_id1');
SET @last_id_in_table1 = LAST_INSERT_ID();
UPDATE Customer SET subscription_id = @last_id_in_table1 WHERE customer.id = 1;

INSERT INTO Subscription (start, end, stripe_id) VALUES ('2017-03-01', null, 'stripe_id2');
SET @last_id_in_table1 = LAST_INSERT_ID();
UPDATE Customer SET subscription_id = @last_id_in_table1 WHERE customer.id = 2;

INSERT INTO Subscription (start, end, stripe_id) VALUES ('2017-03-01', null, 'stripe_id3');
SET @last_id_in_table1 = LAST_INSERT_ID();
...
INSERT INTO Subscription (start, end, stripe_id) VALUES ('2017-12-01', null, 'stripe_id_860');
SET @last_id_in_table1 = LAST_INSERT_ID();
UPDATE Customer SET subscription_id = @last_id_in_table1 WHERE customer.id = 860;
